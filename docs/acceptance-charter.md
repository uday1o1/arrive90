...
The active acceptance charter is `configs/acceptance/travel-time-v1.2.yaml`.
...
Red, Orange, and Blue remain in the complete source-quality audit.
Blue is the only modeled V1 line, while Orange and Red remain diagnostic and cannot affect selection, transforms, training, evaluation, or the explorer bundle.
...
Milestones 0 through 7 are accepted under this charter.
Milestone 7 closed after the public documentation, clean-reader workflow, repository audit, and claim audit all passed without changing the frozen result.
